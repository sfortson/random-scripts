...
import (
	...
	"github.com/sfortson/random-scripts/src/go/grpc/pcbook/service"
...
func TestClientSearchLaptop(t *testing.T) {
	...
	filter := &pb.Filter{
		...
		MinCpuCores: 4,
		MinCpuGhz:   2.2,
		MinRam:      &pb.Memory{Value: 8, Unit: pb.Memory_UNIT_GIGABYTE},
	}
	...
	for i := 0; i < 6; i++ {
		...
		case 3:
			laptop.Ram = &pb.Memory{Value: 4096, Unit: pb.Memory_UNIT_MEGABYTE}
		case 4:
			laptop.PriceUsd = 1999
			laptop.Cpu.NumberCores = 4
			laptop.Cpu.MinGhz = 2.5
			laptop.Cpu.MaxGhz = laptop.Cpu.MinGhz + 2.0
			laptop.Ram = &pb.Memory{Value: 16, Unit: pb.Memory_UNIT_GIGABYTE}
		...
		case 5:
			...
			laptop.Cpu.MaxGhz = laptop.Cpu.MinGhz + 2.0
			laptop.Ram = &pb.Memory{Value: 64, Unit: pb.Memory_UNIT_GIGABYTE}
			expectedIDs[laptop.Id] = true
		}
