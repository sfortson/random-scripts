...
func toBit(memory *pb.Memory) uint64 {
	...
	case pb.Memory_UNIT_BIT:
		return value
	case pb.Memory_UNIT_BYTE:
		return value << 3 // 8 = 2^3
	case pb.Memory_UNIT_KILOBYTE:
		return value << 13 // 1024 * 8 = 2^10 * 2^3 = 2^13
	case pb.Memory_UNIT_MEGABYTE:
		return value << 23
	case pb.Memory_UNIT_GIGABYTE:
		return value << 33
	case pb.Memory_UNIT_TERABYTE:
		return value << 43
	default:
		return 0
	}
